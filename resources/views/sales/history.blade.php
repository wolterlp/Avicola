<x-app-layout>
    ...
    <div class="py-12">
        <!--div class="mx-auto max-w-7xl p-2 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 sm:px-6 lg:px-8 sm:flex-row justify-center items-center gap-4"-->
                ...
                @if (isset($fec_fin))
                    <div class="financial-summary">
                        <table class="financial-table">
                            <thead>
                                <a class="text-align:center" colspan="7">Ventas del {{ __($fec_ini) }} Al {{ __($fec_fin) }}</a>
                                <tr>
